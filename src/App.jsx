  ...
  return (
    <div style={{ maxWidth: 680, margin: "0 auto", padding: isMobile ? "60px 20px 100px" : "120px 40px 160px", textAlign: "center" }}>
      ...
      <div style={{ ...fadeStyle(0), display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 24 : 40, alignItems: "center", textAlign: isMobile ? "center" : "left", marginBottom: isMobile ? 48 : 64, width: "100%", justifyContent: "center" }}>
        ...
        <div>
          <h1 style={{ fontFamily: F_SERIF, fontSize: "clamp(36px, 5vw, 64px)", fontWeight: 700, lineHeight: 1.05, letterSpacing: "-0.02em", color: "#111", marginBottom: 8, textAlign: "center" }}>
            {data.name}
          </h1>
          <div style={{ fontFamily: F_SERIF, fontSize: "clamp(16px, 2vw, 22px)", fontWeight: 400, fontStyle: "italic", color: PURPLE_MID, lineHeight: 1.4, marginBottom: 10, textAlign: "center" }}>
        ...
        <div key={i} style={{ marginBottom: 28, paddingLeft: 20, borderLeft: `3px solid ${PURPLE_LIGHT}` }}>
          {editMode ? (
            ...
            <div style={{ paddingTop: 4 }}>
              ...
              <div style={{ fontFamily: F_SERIF, fontSize: 18, fontWeight: 700, color: "#111", marginBottom: 10 }}>{exp.title}</div>
              {exp.summary && <p style={{ fontSize: 14, color: "#666", lineHeight: 1.75, fontFamily: F_SANS, fontWeight: 300, marginBottom: 14 }}>{exp.summary}</p>}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "148px 1fr", gap: 28, paddingTop: 4 }}>
              ...
              <div>
                <div style={{ fontFamily: F_SERIF, fontSize: 20, fontWeight: 700, color: "#111", marginBottom: 10 }}>{exp.title}</div>
                {exp.summary && <p style={{ fontSize: 14.5, color: "#666", lineHeight: 1.75, fontFamily: F_SANS, fontWeight: 300, marginBottom: 16 }}>{exp.summary}</p>}
